 ...
 *
 * Definition:  In the eval the typed in functions will be evaluated.
 *              For every new function a new object will be
 *
 */
...
void initBuiltinFunctions() {
    ...
    fn = new_builtinFunc(builtinMultiplication);
    add_binding(new_symbol("*"), fn);
...
/*
 * if something goes wrong in the evaluation process
 * then the error will be printed and setjump to start
 */
void scm_error(char* msg, SCM_OBJ optionalArg) {
